document.addEventListener('DOMContentLoaded', function() {
    ...
    for (const input of inputs) {
      // Add event listener to each input field's input event
    ...
    function validateField(input) {
      ...
      if (inputValue === '') {
        ...
        displayErrorMessage(input, `${getFieldName(input)} is required`); // Display the error message
        isValid = false; // Set isValid to false
      } else {
        switch (input) {
          case firstNameInput:
          ...
          case passwordInput:
            if (!validatePassword(inputValue)) {
              ...
              displayErrorMessage(input, 'Password is invalid'); // Display the error message
              isValid = false; // Set isValid to false
            } else {
